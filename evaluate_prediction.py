...
parser.add_argument('--model-dir', default='./Results/resnet30_lr_0.05/model_best.pth.tar',
...
def main():
    ...
    if args.model_dir:
        if os.path.isfile(args.model_dir):
            ...
            print("=> loaded checkpoint '{}' (best_prec1 {})".format(args.model_dir, checkpoint['best_prec1']))
        else:
