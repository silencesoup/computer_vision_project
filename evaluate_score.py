...
parser = argparse.ArgumentParser(description='PyTorch Cross Domain Evaluating')
...
parser.add_argument('--test_dataset', default='DLUT_VLG_Cross_Domain')
...
parser.add_argument('--model-dir', default='./Results/resnet30_lr_0.05/model_best.pth.tar',type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
...
def main():
    ...
    dataframe =pd.DataFrame(score, index=imgs, columns=['score_%d'%i for i in range(args.num_classes)])
