...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, classifier=None, num_classes=64, dropout=0.0, global_pool=True):
        super(ResNet, self).__init__()
        self.initial_pool = False
        inplanes = self.inplanes = 32
...
def resnet30(pretrained=False, pretrained_model_path=None, **kwargs):
    """
        Constructs a ResNet-30 model.
    """
    model = ResNet(BasicBlock, [3, 4, 4, 3], **kwargs)
